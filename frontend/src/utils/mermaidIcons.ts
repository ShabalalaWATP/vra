/**
 * Bundled icon pack for mermaid architecture-beta diagrams.
 * Uses Iconify JSON format with SVG paths from Lucide (MIT license).
 * This allows air-gapped mermaid rendering with icons.
 */
...
export const vrIcons = {
  ...
  icons: {
    ...
    "container": {
      body: '<path d="M22 12.5V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12c0 1.1.9 2 2 2h7.5"/><path d="m22 17-5 5-5-5"/><path d="M17 22v-7"/><line x1="6" x2="6.01" y1="8" y2="8"/>',
    },
    "network": {
    ...
    "browser": {
      body: '<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M2 8h20"/><path d="M6 8V4"/><path d="M10 8V4"/>',
    },
    "api": {
      body: '<path d="m15 12-8.5 8.5c-.83.83-2.17.83-3 0 0 0 0 0 0 0a2.12 2.12 0 0 1 0-3L12 9"/><path d="M17.64 15 22 10.64"/><path d="m20.91 11.7-1.25-1.25c-.6-.6-.93-1.4-.93-2.25v-.86L16.01 4.6a5.56 5.56 0 0 0-3.94-1.64H9l.92.82A6.18 6.18 0 0 1 12 8.4v1.56l2 2h2.47l2.26 1.91"/>',
    },
    "webhook": {
      body: '<path d="M18 16.98h-5.99c-1.1 0-1.95.68-2.95 1.04C8.07 18.4 7 18.5 6 18.3c-1.51-.35-2.74-1.37-3.43-2.73"/><path d="M9.5 8.02C10.07 7.38 10.5 6.63 10.5 5.7c0-1.51-.72-2.86-1.85-3.68"/><circle cx="12" cy="12" r="10"/>',
    },
    ...
    // Data & Storage
    "harddrive": {
      body: '<line x1="22" x2="2" y1="12" y2="12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" x2="6.01" y1="16" y2="16"/><line x1="10" x2="10.01" y1="16" y2="16"/>',
    },
    "cache": {
      body: '<path d="M12 2v4"/><path d="m16.24 7.76 2.83-2.83"/><path d="M22 12h-4"/><path d="m16.24 16.24 2.83 2.83"/><path d="M12 18v4"/><path d="m4.93 19.07 2.83-2.83"/><path d="M2 12h4"/><path d="m4.93 4.93 2.83 2.83"/><circle cx="12" cy="12" r="4"/>',
    },
...
/** List of available icon names for use in prompts */
export const AVAILABLE_ICONS = Object.keys(vrIcons.icons);

/** Formatted list for AI prompts */
export const ICON_LIST_FOR_PROMPT = AVAILABLE_ICONS.join(", ");
