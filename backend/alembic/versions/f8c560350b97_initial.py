...
def upgrade() -> None:
    ...
    sa.Column('files_inspected', sa.JSON(), nullable=True),
    ...
    sa.Column('exploit_prerequisites', sa.JSON(), nullable=True),
    ...
    sa.Column('scanner_hits', sa.JSON(), nullable=True),
    ...
    sa.Column('scan_coverage', sa.JSON(), nullable=True),
    ...
    sa.Column('vulnerable_functions', sa.JSON(), nullable=True),
